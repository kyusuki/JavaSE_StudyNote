...
public class LoginJFrame extends JFrame implements ActionListener{
    ...
    */
    ...
    private void initView(){
        this.setContentPane(new JLabel(loadIcon("image/login/background.png")));
        this.getContentPane().setLayout(null);

        //添加用户名文字
        ImageIcon userImage=loadIcon("image/login/用户名.png");
        ...
        //添加密码文字
        ImageIcon passwordImage=loadIcon("image/login/密码.png");
        ...
        //验证码提示
        ImageIcon codeImage=loadIcon("image/login/验证码.png");
        ...
        ImageIcon loginImage=loadIcon("image/login/登录按钮.png");
        ...
        ImageIcon registerImage=loadIcon("image/login/注册按钮.png");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(obj==login){
            ...
            login.setIcon(loadIcon("image/login/登录按下.png"));

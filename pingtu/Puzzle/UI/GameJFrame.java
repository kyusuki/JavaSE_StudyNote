...
public class GameJFrame extends JFrame implements KeyListener,ActionListener{
    ...
    int x=0,y=0;
    //记录路径
    String path="D:\\java\\FreeExercises\\Puzzle\\image\\animal\\animal1\\";
    //记录步数
    int step=0;
    ...
    private void initImage(){
        ...
        */
        ...
        if(isVictor()){
            //显示胜利图标
            ImageIcon winImage=new ImageIcon("D:\\java\\FreeExercises\\Puzzle\\image\\win.png");
        ...
        ImageIcon bk=new ImageIcon("D:\\java\\FreeExercises\\Puzzle\\image\\background.png");
        JLabel jLabel=new JLabel(bk);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(obj==replayItem){ //注意顺序
            ...
            path="D:\\java\\FreeExercises\\Puzzle\\image\\animal\\animal"+index+"\\";
            //重计步数
            step=0;
            //重新初始化数据
            initDate();
            ...
            path="D:\\java\\FreeExercises\\Puzzle\\image\\girl\\girl"+index+"\\";
            //重计步数
            step=0;
            //重新初始化数据
            initDate();
            ...
            path="D:\\java\\FreeExercises\\Puzzle\\image\\man\\man"+index+"\\";
            //重计步数
            step=0;
            //重新初始化数据
            initDate();
            ...
            Random r=new Random();
            int index=r.nextInt(10)+1;
            path="D:\\java\\FreeExercises\\Puzzle\\image\\sport\\sport"+index+"\\";
            //重计步数
            step=0;
            //重新初始化数据
            initDate();
            ...
            //创建图片对象
            ImageIcon image=new ImageIcon("C:\\Users\\30324\\Downloads\\李现_cropped.jpg");
            //创建图图片的管理容器
